...
var FeedUrl = TMDUrl + "toolbar/ff/ff.xml.php" ;
...
function init()
{
  ...
  TMDUrl = "http://www.torrentsmd."+domain+"/"; //var TMDUrl = "http://flienteen.pc/";
  FeedUrl = TMDUrl + "toolbar/ff/ff.xml.php";
